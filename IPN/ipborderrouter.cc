...
{
/*---------------------------------------*/
ip_nic.insert(0x20a0a0a,1);
ip_nic.insert(0x102a8c0,2);




/*---------------------------------------*/
s_ip.insert(1,0x10a0a0a);
s_ip.insert(2,0x202a8c0);



/*---------------------------------------*/

pid_ip.insert("PID1",0x20a0a0a);

/*---------------------------------------*/
nid_ip.insert("d3rm",0x102a8c0);
